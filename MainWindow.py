...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "验证码标注辅助工具"))
        ...
        self.label_2.setText(_translate("MainWindow", "完成输入后请按Enter切换下一张图片..."))
        self.pushButtonBack.setText(_translate("MainWindow", "回到上一张图片"))
